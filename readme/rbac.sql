...
VALUES (1, 'admin', '$2y$10$l25yEwI66Ej7x7M5nDsIou68LF./S9ZKOqAjDPzjhi8pk74a3J70C', 'xiaoxi@qq.com',
        'gdIg4uQBzVgJHTbQexBABO4Gz3VyXenWHYq1sDJbRft3lKit77sn5tfYw4cV', 1553752888, 1553752888, 0),
       (2, 'xiaoxi', '$2y$10$l25yEwI66Ej7x7M5nDsIou68LF./S9ZKOqAjDPzjhi8pk74a3J70C', 'xiaoxi@qq.com', NULL, 1554265387,
        1554265387, 0);
...
VALUES (1, 1, 1, 1553752888, 1553752888, 0),
...
VALUES (1, '超级管理员', '拥有所有权限', 'super_admin', 1553752888, 1554211896, 0);
...
VALUES (1, 1, 1, 1554211896, 1554211896, 0),
...
INSERT INTO `permissions` (`id`, `name`, `description`, `pid`, `icon`, `route`, `sort`, `created_at`, `updated_at`,
                           `deleted_at`)
VALUES (1, '权限管理', '菜单 - 权限管理', 0, 'vercode', '', 0, 1553752888, 1553752888, 0),
